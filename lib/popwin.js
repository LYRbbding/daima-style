...
showWin: function(width, height, title, src) {
        ...
        inntHtml += '<div id="maskTitle" style="line-height: 50px;border-radius: 8px;  font-family: Microsoft Yahei; font-size: 20px; color: #333333; padding-left: 20px; text-align:center; position: relative;">'
        inntHtml += '' + title + ''
