...
$('body').on("click", ".login",
    function () {
        var titleLogin = '<span class="active" onclick="$(this).addClass(\'active\').siblings().removeClass(\'active\');$(\'#maskTop iframe\').attr(\'src\',\'https://my.ruanmei.com/wechat/login.html?source=ithome' + (nightMode ? '&night=1' : "") + '\');">扫码登录</span><span onclick="$(this).addClass(\'active\').siblings().removeClass(\'active\');$(\'#maskTop iframe\').attr(\'src\',\'https://my.ruanmei.com/?source=ithome' + (nightMode ? '&night=1' : "") + '\')">其他方式登录</span>';
        popWin.showWin("400", "620", titleLogin, "https://my.ruanmei.com/wechat/login.html?source=ithome" + (nightMode ? '&night=1' : ""));
    });
$('body').on("click",
    "#btnLogout",
    function () {
